...
public class Keys {
    ...
    public static final ForeignKey<ChatLinkRecord, LinksRecord> CONSTRAINT_868 = Internal.createForeignKey(ChatLink.CHAT_LINK, DSL.name("CONSTRAINT_868"), new TableField[] { ChatLink.CHAT_LINK.LINK_ID }, Keys.CONSTRAINT_4, new TableField[] { Links.LINKS.ID }, true);
}
