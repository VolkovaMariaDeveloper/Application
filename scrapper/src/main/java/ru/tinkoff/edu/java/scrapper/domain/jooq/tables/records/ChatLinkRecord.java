...
public class ChatLinkRecord extends UpdatableRecordImpl<ChatLinkRecord> implements Record2<Integer, Integer> {
    ...
    @Override
    @NotNull
    public ChatLinkRecord value2(@NotNull Integer value) {
        setLinkId(value);
        return this;
    }
    ...
    @Override
    @NotNull
    public ChatLinkRecord values(@NotNull Integer value1, @NotNull Integer value2) {
        value1(value1);
        value2(value2);
        return this;
    }
    ...
    public ChatLinkRecord(@NotNull Integer chatId, @NotNull Integer linkId) {
        super(ChatLink.CHAT_LINK);
