...
public class Links extends TableImpl<LinksRecord> {
    ...
    public final TableField<LinksRecord, OffsetDateTime> LAST_CHECK_TIME =
        createField(DSL.name("LAST_CHECK_TIME"), SQLDataType.TIMESTAMPWITHTIMEZONE(6), this, "");
    /**
    ...
    public <U> SelectField<U> mapping(
        Class<U> toType,
        Function4<? super String, ? super Long, ? super OffsetDateTime, ? super Integer, ? extends U> from
    ) {
