...
public class LinksRecord extends UpdatableRecordImpl<LinksRecord> implements Record4<String, Long, LocalDateTime, Integer> {
    ...
    @Override
    @NotNull
    public Row4<String, Long, LocalDateTime, Integer> valuesRow() {
    ...
    @Override
    @NotNull
    public LinksRecord values(@NotNull String value1, @NotNull Long value2, @Nullable LocalDateTime value3, @Nullable Integer value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
    ...
    public LinksRecord(@NotNull String url, @NotNull Long id, @Nullable LocalDateTime lastCheckTime, @Nullable Integer count) {
        super(Links.LINKS);
