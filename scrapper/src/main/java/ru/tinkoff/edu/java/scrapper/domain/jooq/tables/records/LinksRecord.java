...
public class LinksRecord extends UpdatableRecordImpl<LinksRecord> implements Record5<String, Long, LocalDateTime, String, Integer> {
     ...
     */
    public void setBranchesList(@Nullable String value) {
        set(3, value);
    }
    ...
    @Override
    @NotNull
    public Row5<String, Long, LocalDateTime, String, Integer> valuesRow() {
    ...
    public Field<String> field4() {
        return Links.LINKS.BRANCHES_LIST;
    }
    ...
    public LinksRecord value4(@Nullable String value) {
        setBranchesList(value);
        return this;
    }

    @Override
    @NotNull
    public LinksRecord value5(@Nullable Integer value) {
        setCount(value);
        return this;
    }
    ...
    @Override
    @NotNull
    public LinksRecord values(@NotNull String value1, @NotNull Long value2, @Nullable LocalDateTime value3, @Nullable String value4, @Nullable Integer value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
    ...
    public LinksRecord(@NotNull String url, @NotNull Long id, @Nullable LocalDateTime lastCheckTime, @Nullable String branchesList, @Nullable Integer count) {
        super(Links.LINKS);
    ...
    public LinksRecord(ru.tinkoff.edu.java.scrapper.domain.jooq.tables.pojos.Links value) {
        ...
        if (value != null) {
            ...
            setBranchesList(value.getBranchesList());
